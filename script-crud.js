...
const toggleFormBtn = document.querySelector(".app__button--add-task");
const closeFormBtn = document.querySelector(
  ".app__form-footer__button--cancel"
);
const deleteFormBtn = document.querySelector(
...
const editarTarefas = (tarefa, elemento) => {
  if (tarefaEmEdicao == tarefa) {
    limparForm();
    return;
  }
  formLabel.textContent = "Editando...";
...
function createTask(tarefa) {
  ...
  button.addEventListener("click", (event) => {
    ...
    editarTarefas(tarefa, paragrafo);
  });
...
toggleFormBtn.addEventListener("click", () => {
  formLabel.textContent = "Nova Tarefa";
...
document.addEventListener("TarefaFinalizada", function (event) {
  if (tarefaSelecionada) {
    tarefaSelecionada.concluida = true;
